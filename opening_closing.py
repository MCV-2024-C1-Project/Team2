...
def process_folder_and_evaluate(image_folder):
    ...
    for filename in os.listdir(image_folder):
        if filename.endswith('.jpg'):
            ...
            print(f"Results for {filename} after opening/closing:")
            print(f"  IoU (RGB): {iou_rgb_closing:.4f}")
            print(f"  IoU (HSV): {iou_hsv_closing:.4f}")
            print(f"  IoU (LAB): {iou_lab_closing:.4f}")
    ...
    if num_images > 0:
        ...
        avg_iou_rgb_closing = total_iou_rgb_closing / num_images
        avg_iou_hsv_closing = total_iou_hsv_closing / num_images
        avg_iou_lab_closing = total_iou_lab_closing / num_images
        ...
        print("\nOverall Performance after opening/closing:")
        print(f"  Average IoU (RGB): {avg_iou_rgb_closing:.4f}")
        print(f"  Average IoU (HSV): {avg_iou_hsv_closing:.4f}")
        print(f"  Average IoU (LAB): {avg_iou_lab_closing:.4f}")
    else:
