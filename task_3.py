    ...
    if file_compare_image.endswith('.pkl') and file_compare_image != 'gt_corresps.pkl':
        ...
        for filename in os.listdir(directory_bbdd):
            if filename.endswith('.pkl') and filename != 'relationships.pkl':
                ...
                histogram_first_grey = histograms_first['hist_RGB']
                histogram_grey = histograms['hist_RGB']
        ...
        list_results_k_5.append(top_k_10_results)
...
print("Method 1; k=1:", utils.mapk(ground_truth, list_results_k_1, k=1))
print("Method 1; k=5:", utils.mapk(ground_truth, list_results_k_5, k=5))
...
print("Method 2; k=1:", utils.mapk(ground_truth, list_results_k_1, k=1))
print("Method 2; k=5:", utils.mapk(ground_truth, list_results_k_5, k=5))
