...
print("Method 1 - HSV with X2 distance; k=1 mapk:", utils.mapk(ground_truth, list_results_k_1, k=1))
print("Method 1 - HSV with X2 distance; k=5 mapk:", utils.mapk(ground_truth, predicted_flattened_k_5, k=5))
...
print("Method 2 - LAB with X2 distance; k=1 mapk:", utils.mapk(ground_truth, list_results_k_1, k=1))
print("Method 2 - LAB with X2 distance; k=5 mapk:", utils.mapk(ground_truth, predicted_flattened_k_5, k=5))
...
print("Method 3 - HSV with our metric; k=1 mapk:", utils.mapk(ground_truth, list_results_k_1, k=1))
print("Method 3 - HSV with our metric; k=5 mapk:", utils.mapk(ground_truth, predicted_flattened_k_5, k=5))

#To ensure that they are integers
list_results_k_10_enteros = [[int(x) for x in sublist] for sublist in list_results_k_10]

# store results k=10
with open('results/week1/method3/result.pkl', 'wb') as pkl_file:
    pickle.dump(list_results_k_10_enteros, pkl_file)
