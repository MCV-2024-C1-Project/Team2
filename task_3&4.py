...
print("Method 1 - HSV with our metric; k=1 mapk:", utils.mapk(ground_truth, list_results_k_1, k=1))
print("Method 1 - HSV with our metric; k=5 mapk:", utils.mapk(ground_truth, predicted_flattened_k_5, k=5))
...
print("Method 3 - HSV with X2 distance; k=1 mapk:", utils.mapk(ground_truth, list_results_k_1, k=1))
print("Method 3 - HSV with X2 distance; k=5 mapk:", utils.mapk(ground_truth, predicted_flattened_k_5, k=5))
