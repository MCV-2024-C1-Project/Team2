...
def process_matches_with_masks(directory, bbdd_directory):
    ...
    for filename_query in sorted(os.listdir(directory)):
        if filename_query.endswith('.jpg') and filename_query != 'gt_corresps.pkl':
...
# Start with qsd2_w3
directory = '../week3/filtered_cropped_qsd2_w3'  # Directory containing the filtered images
directory_bbdd = '../../data/BBDD'  # Directory containing the database of images
